# Step By Step: A Hierarchical Framework for Multi-hop Reasoning with Reinforcement Learning

In our experiments, the five datasets used are: `umls`, `kinship`, `fb15k-237` and `nell-995`. 
